module.exports=({emailFrom, downloadLink,size,expires})=>{
    ...
    <body class="" style="background-color: #f6f6f6; font-family:sans-sarif; -webkit-font-smoothing:antialiased; font-size:14px; line-height:1.4; margin:0;
    padding:0; -ms-text-size-adjust:100%; -webkit-text-size-adjust:100%">
        <table border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse:separate; mso-table-lspace:0pt; msp-table-rspace:0pt; width:100%; background-color:#f6f6f6;">
        <tr>
            ...
            <div class="content" style="box-sizing: border-box; display:block; Margin:0 auto; max-width:580px; padding:10px;">
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">${size} in total &middot; Expires in ${expires}</p>
              ...
              <div class="footer">
                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                sytle=" align-items=center, justify-content:center">
                  <tr>
